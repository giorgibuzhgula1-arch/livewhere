...
const VISA_DATA: CountryVisaInfo[] = [
  ...
  },
  {
    ...
    visaScore: 54,
    summary:
      'Japan lacks a dedicated retiree visa — digital nomad and designated-activities stays cover some long-stay cases.',
    options: [
      {
        ...
        processingTime: '1–2 months',
        cost: '$25–$60',
        minIncomeMonthly: 5600,
        duration: '6 months (non-renewable in category)',
        requirements: [
          'Remote work for foreign employer with ¥10M+ annual income (approx.)',
          'Private health insurance',
          'Valid passport',
          'Official source: https://www.mofa.go.jp/ca/fna/visa/index.html',
        ],
      },
      {
        name: 'Tourist / Short-Term Stay',
        type: 'Tourist Visa',
        difficulty: 'Easy',
        processingTime: 'Visa-free for many',
        cost: '$0–$30',
