...
const TESTIMONIALS = [
  {
    ...
    stars: 5,
    text: "I wasn't expecting much, to be honest. I entered my details, and Tbilisi came out on top. Georgia wasn't even on my radar. I spent a few days looking into it, and the recommendation actually made sense. I've been living here for four months now — my rent is $480, the internet is great, and I haven't looked back.",
  },
  {
    name: 'Priya N.',
    role: 'Data Analyst',
  ...
  },
  {
    ...
    stars: 5,
    text: "The recommendations aren't perfect, and you should absolutely do your own research before moving anywhere. But if you need a way to narrow hundreds of options down to a handful of places worth seriously considering, it's incredibly useful.",
  },
  {
    name: 'Kevin O.',
    role: 'Developer',
